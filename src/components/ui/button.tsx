  ...
  "inline-flex items-center justify-center text-base ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outlineSecondary:
          "bg-transparent border-border hover:bg-secondary hover:border-transparent hover:text-secondary-foreground",
        outlinePrimary:
          "bg-transparent border-border hover:bg-primary hover:border-transparent hover:text-primary-foreground",
        accent:
        ...
        outlineDestructive:
          "bg-transparent border-border hover:text-destructive-foreground hover:bg-destructive hover:border-transparent",
      ...
      size: {
        none: "",
        default: "h-9 border rounded-full px-6",
        xs: "h-8 border rounded-md px-2 text-sm",
        sm: "h-9 border rounded-md px-3",
        md: "h-10 border rounded-md px-12",
