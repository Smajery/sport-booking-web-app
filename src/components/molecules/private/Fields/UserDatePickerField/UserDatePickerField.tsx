...
import YearSelect from "@/components/atoms/private/Selects/YearSelect/YearSelect";
    ...
    <FormField
      ...
      render={({ field, fieldState: { invalid } }) => (
        <FormItem>
          ...
          <FormControl>
            <div className="flex items-center gap-x-unit-5">
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    size="none"
                    className={cn(
                      "h-10 w-full justify-start gap-x-unit-2 rounded-md border bg-background px-3 py-2 border-input text-2xl",
                ...
                <PopoverContent className="w-auto p-0">
                  <div>
                    <div className="px-unit-3 flex items-center border-b-1 border-border">
